...
export default function Home() {
  ...
  // 오른쪽 결과 영역 내부 (상단은 파이 차트, 하단은 종목 및 할당 %를 3열 그리드로 표시)
    ...
    <div style={mainContainerStyle}>
      ...
      <div style={formColumnStyle}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <div className="tooltip" style={tooltipContainerStyle}>
            <span style={{ fontSize: "24px", cursor: "pointer" }}>ℹ</span>
            <div className="tooltip-text">
              <span style={{ padding: "5px" }}>
                This system optimizes your portfolio by analyzing various financial metrics including PER, Dividend Yield, Beta, RSI, Volume, and Volatility.
              </span>
              <div
                style={{
                  position: "absolute",
